	...
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if len(errMsgs) != 0 {
			...
			for _, msg := range errMsgs {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `templ/partials/flash-messages.templ`, Line: 8, Col: 30}
				}
		...
		if len(sucMsgs) != 0 {
			...
			for _, msg := range sucMsgs {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `templ/partials/flash-messages.templ`, Line: 16, Col: 30}
				}
